...
const image = `iVBORw0KGgoAAAANSUhEUgAAAqgAAAKoCAYAAAC7uA1cAAAABHNCSVQICAgIfAhkiAAAIABJREFU
...
export const handlers = [
    rest.get('https://matrix.example.com/_matrix/media/v3/download/midnightthoughts.space/59ced67d3dfbcc5c129c3e12d3083bf5652f6ff5', async (_, res, ctx) => {
    ...
    rest.get('https://matrix.example.com/_matrix/client/v3/profile/@example:example.com', async (_, res, ctx) => {
        return res(
            ctx.status(200),
            ctx.json({
                "avatar_url": "mxc://midnightthoughts.space/59ced67d3dfbcc5c129c3e12d3083bf5652f6ff5",
                "displayname": "Alice Margatroid"
            }),
        )
    }),
    rest.post('https://matrix.example.com/_matrix/client/v3/logout', async (_, res, ctx) => {
        return res(
            ctx.status(200),
            ctx.json({}),
        )
    }),
    rest.post('https://sliding.matrix.example.com/_matrix/client/unstable/org.matrix.msc3575/sync', async (_, res, ctx) => {
        return res(
            ctx.status(404),
            ctx.json({
                "errcode": "M_UNKNOWN",
    ...
    rest.post('https://matrix.example.com/_matrix/client/v3/keys/upload', async (_, res, ctx) => {
        return res(
            ctx.status(200),
            ctx.json({
                "one_time_key_counts": {
    ...
    rest.post('https://matrix.example.com/_matrix/client/v3/keys/query', async (_, res, ctx) => {
        return res(
            ctx.status(200),
            ctx.json({})
        )
