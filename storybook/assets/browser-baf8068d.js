...
Invalid value has been removed from localStorage to prevent subsequent failed parsing attempts.`),localStorage.removeItem(e.PERSISTENCY_KEY)}}persist(){if(!n())return;const a=Array.from(this.store.entries()).map(([s,u])=>[s,Array.from(u.entries())]);localStorage.setItem(e.PERSISTENCY_KEY,JSON.stringify(a))}deleteExpiredCookies(){const a=Date.now();this.store.forEach((s,u)=>{s.forEach(({expires:c,name:l})=>{c!==void 0&&c.getTime()<=a&&s.delete(l)}),s.size===0&&this.store.delete(u)})}}e.store=new i})(Eu);(function(e){var t=K&&K.__createBinding||(Object.create?function(n,i,o,a){a===void 0&&(a=o),Object.defineProperty(n,a,{enumerable:!0,get:function(){return i[o]}})}:function(n,i,o,a){a===void 0&&(a=o),n[a]=i[o]}),r=K&&K.__exportStar||function(n,i){for(var o in n)o!=="default"&&!Object.prototype.hasOwnProperty.call(i,o)&&t(i,n,o)};Object.defineProperty(e,"__esModule",{value:!0}),r(Eu,e)})(Ao);var Fi,es;function qp(){return es||(es=1,Fi=function(){function e(t,r,n,i,o){return t<r||n<r?t>n?n+1:t+1:i===o?r:r+1}return function(t,r){if(t===r)return 0;if(t.length>r.length){var n=t;t=r,r=n}for(var i=t.length,o=r.length;i>0&&t.charCodeAt(i-1)===r.charCodeAt(o-1);)i--,o--;for(var a=0;a<i&&t.charCodeAt(a)===r.charCodeAt(a);)a++;if(i-=a,o-=a,i===0||o<3)return o;var s=0,u,c,l,f,d,v,w,T,A,b,B,C,E=[];for(u=0;u<i;u++)E.push(u+1),E.push(t.charCodeAt(a+u));for(var P=E.length-1;s<o-3;)for(A=r.charCodeAt(a+(c=s)),b=r.charCodeAt(a+(l=s+1)),B=r.charCodeAt(a+(f=s+2)),C=r.charCodeAt(a+(d=s+3)),v=s+=4,u=0;u<P;u+=2)w=E[u],T=E[u+1],c=e(w,c,l,A,T),l=e(c,l,f,b,T),f=e(l,f,d,B,T),v=e(f,d,v,C,T),E[u]=v,d=f,f=l,l=c,c=w;for(;s<o;)for(A=r.charCodeAt(a+(c=s)),v=++s,u=0;u<P;u+=2)w=E[u],E[u]=v=e(w,c,v,A,E[u+1]),c=w;return v}}()),Fi}const Hp="16.8.1",Vp=Object.freeze({major:16,minor:8,patch:1,preReleaseTag:null});function ue(e,t){if(!!!e)throw new Error(t)}function qe(e){return typeof e?.then=="function"}function He(e){return typeof e=="object"&&e!==null}function Ie(e,t){if(!!!e)throw new Error(t??"Unexpected invariant triggered.")}const zp=/\r\n|[\n\r]/g;function Dn(e,t){let r=0,n=1;for(const i of e.body.matchAll(zp)){if(typeof i.index=="number"||Ie(!1),i.index>=t)break;r=i.index+i[0].length,n+=1}return{line:n,column:t+1-r}}function Du(e){return vo(e.source,Dn(e.source,e.start))}function vo(e,t){const r=e.locationOffset.column-1,n="".padStart(r)+e.body,i=t.line-1,o=e.locationOffset.line-1,a=t.line+o,s=t.line===1?r:0,u=t.column+s,c=`${e.name}:${a}:${u}
...
%s`,a.message))}return s};function Nl(e={}){if(e.quiet)return;const t=e.message||"Mocking enabled.";console.groupCollapsed(`%c${ve.formatMessage(t)}`,"color:orangered;font-weight:bold;"),console.log("%cDocumentation: %chttps://mswjs.io/docs","font-weight:bold","font-weight:normal"),console.log("Found an issue? https://github.com/mswjs/msw/issues"),e.workerUrl&&console.log("Worker script URL:",e.workerUrl),e.workerScope&&console.log("Worker scope:",e.workerScope),console.groupEnd()}async function Tv(e,t){var r,n;if(e.workerChannel.send("MOCK_ACTIVATE"),await e.events.once("MOCKING_ENABLED"),e.isMockingEnabled){ve.warn('Found a redundant "worker.start()" call. Note that starting the worker while mocking is already enabled will have no effect. Consider removing this "worker.start()" call.');return}e.isMockingEnabled=!0,Nl({quiet:t.quiet,workerScope:(r=e.registration)==null?void 0:r.scope,workerUrl:(n=e.worker)==null?void 0:n.scriptURL})}var wv=class{constructor(e){this.port=e}postMessage(e,...t){const[r,n]=t;this.port.postMessage({type:e,data:r},{transfer:n})}},Cl=class extends Error{constructor(e){super(e),this.name="NetworkError"}},Iv=kn,Sv=We,Nv=en(Hr),Ws=Ao,Cv=kn,Bv=et,Ov=We,Pv=en(Hr);function Ys(){return Pv.parse(document.cookie)}function Rv(e){if(typeof document>"u"||typeof location>"u")return{};switch(e.credentials){case"same-origin":return location.origin===e.url.origin?Ys():{};case"include":return Ys();default:return{}}}var kv=We;function Lv(e){var t,r;const n=(0,kv.stringToHeaders)(e),i=n.get("content-type")||"text/plain",o=n.get("content-disposition");if(!o)throw new Error('"Content-Disposition" header is required.');const a=o.split(";").reduce((c,l)=>{const[f,...d]=l.trim().split("=");return c[f]=d.join("="),c},{}),s=(t=a.name)==null?void 0:t.slice(1,-1),u=(r=a.filename)==null?void 0:r.slice(1,-1);return{name:s,filename:u,contentType:i}}function xv(e,t){const r=t?.get("content-type");if(!r)return;const[,...n]=r.split(/; */),i=n.filter(u=>u.startsWith("boundary=")).map(u=>u.replace(/^boundary=/,""))[0];if(!i)return;const o=new RegExp(`--+${i}`),a=e.split(o).filter(u=>u.startsWith(`\r
`)&&u.endsWith(`\r
`)).map(u=>u.trimStart().replace(/\r\n$/,""));if(!a.length)return;const s={};try{for(const u of a){const[c,...l]=u.split(`\r
\r
`),f=l.join(`\r
\r
`),{contentType:d,filename:v,name:w}=Lv(c),T=v===void 0?f:new File([f],v,{type:d}),A=s[w];A===void 0?s[w]=T:Array.isArray(A)?s[w]=[...A,T]:s[w]=[A,T]}return s}catch{return}}function Bl(e,t){var r;if(!e)return e;const n=((r=t?.get("content-type"))==null?void 0:r.toLowerCase())||"";return n.startsWith("multipart/form-data")&&typeof e!="object"?xv(e.toString(),t)||e:n.includes("json")&&typeof e!="object"&&wt(e.toString())||e}function sa(e,t){return e.toLowerCase()===t.toLowerCase()}var tn=class extends Cv.IsomorphicRequest{constructor(e,t={}){super(e,t),t.id&&(this.id=t.id),this.cache=t.cache||"default",this.destination=t.destination||"",this.integrity=t.integrity||"",this.keepalive=t.keepalive||!1,this.mode=t.mode||"cors",this.priority=t.priority||"auto",this.redirect=t.redirect||"follow",this.referrer=t.referrer||"",this.referrerPolicy=t.referrerPolicy||"no-referrer",this.cookies=t.cookies||this.getCookies()}get body(){const e=(0,Bv.decodeBuffer)(this._body),t=Bl(e,this.headers);if(!(sa(this.method,"GET")&&t===""))return t}passthrough(){return{status:101,statusText:"Continue",headers:new Ov.Headers,body:null,passthrough:!0,once:!1}}getCookies(){var e;const t=this.headers.get("cookie"),r=t?Nv.parse(t):{};Ws.store.hydrate();const n=Array.from((e=Ws.store.get({...this,url:this.url.href}))==null?void 0:e.entries()).reduce((a,[s,{value:u}])=>Object.assign(a,{[s.trim()]:u}),{}),o={...Rv(this),...n};for(const[a,s]of Object.entries(o))this.headers.append("cookie",`${a}=${s}`);return{...o,...r}}};function Fv(e){const t=new URL(e.url),r=new Sv.Headers(e.headers);return new tn(t,{...e,body:(0,Iv.encodeBuffer)(e.body||""),headers:r})}var Mv=St,Qv=async(e,t,r)=>{const n=t.filter(o=>o.test(e,r));if(n.length===0)return{handler:void 0,response:void 0};const i=await n.reduce(async(o,a)=>{const s=await o;if(s?.response)return o;const u=await a.run(e,r);return u===null||u.handler.shouldSkip?null:u.response?(u.response.once&&a.markAsSkipped(!0),u):{request:u.request,handler:u.handler,response:void 0,parsedResult:u.parsedResult}},Promise.resolve(null));return i?{handler:i.handler,publicRequest:i.request,parsedRequest:i.parsedResult,response:i.response}:{handler:void 0,response:void 0}},Ol=en(qp()),Uv=CA,rn=e=>e.referrer.startsWith(e.url.origin)?e.url.pathname:new URL(e.url.pathname,`${e.url.protocol}//${e.url.host}`).href;function Pl(e){var t;const r=e.definitions.find(n=>n.kind==="OperationDefinition");return{operationType:r?.operation,operationName:(t=r?.name)==null?void 0:t.value}}function jv(e){try{const t=(0,Uv.parse)(e);return Pl(t)}catch(t){return t}}function qv(e,t,r){const n={variables:e};for(const[i,o]of Object.entries(t)){if(!(i in r))throw new Error(`Given files do not have a key '${i}' .`);for(const a of o){const[s,...u]=a.split(".").reverse(),c=u.reverse();let l=n;for(const f of c){if(!(f in l))throw new Error(`Property '${c}' is not in operations.`);l=l[f]}l[s]=r[i]}}return n.variables}function Hv(e){var t,r;switch(e.method){case"GET":{const n=e.url.searchParams.get("query"),i=e.url.searchParams.get("variables")||"";return{query:n,variables:wt(i)}}case"POST":{if((t=e.body)!=null&&t.query){const{query:n,variables:i}=e.body;return{query:n,variables:i}}if((r=e.body)!=null&&r.operations){const{operations:n,map:i,...o}=e.body,a=wt(n)||{};if(!a.query)return null;const s=wt(i||"")||{},u=a.variables?qv(a.variables,s,o):{};return{query:a.query,variables:u}}}default:return null}}function Rl(e){const t=Hv(e);if(!t||!t.query)return;const{query:r,variables:n}=t,i=jv(r);if(i instanceof Error){const o=rn(e);throw new Error(ve.formatMessage(`Failed to intercept a GraphQL request to "%s %s": cannot parse query. See the error message from the parser below.

%s`,e.method,o,i.message))}return{operationType:i.operationType,operationName:i.operationName,variables:n}}function kl(e){return e<300?"#69AB32":e<400?"#F0BB4B":"#E95F5D"}function Ll(){const e=new Date;return[e.getHours(),e.getMinutes(),e.getSeconds()].map(String).map(t=>t.slice(0,2)).map(t=>t.padStart(2,"0")).join(":")}function xl(e){return{...e,body:e.body,headers:e.headers.all()}}var Vv=We;function Fl(e){const t=(0,Vv.objectToHeaders)(e.headers),r=Bl(e.body,t);return{...e,body:r}}var zv=FA,Gv=zr,Xv=/[\?|#].*$/g;function Jv(e){return new URL(`/${e}`,"http://localhost").searchParams}function ua(e){return e.replace(Xv,"")}function Wv(e){return/^([a-z][a-z\d\+\-\.]*:)?\/\//i.test(e)}function Yv(e,t){if(Wv(e)||e.startsWith("*"))return e;const r=t||typeof document<"u"&&document.baseURI;return r?decodeURI(new URL(encodeURI(e),r).href):e}function Kv(e,t){if(e instanceof RegExp)return e;const r=Yv(e,t);return ua(r)}function Zv(e){return e.replace(/([:a-zA-Z_-]*)(\*{1,2})+/g,(t,r,n)=>{const i="(.*)";return r?r.startsWith(":")?`${r}${n}`:`${r}${i}`:i}).replace(/([^\/])(:)(?=\d+)/,"$1\\$2").replace(/^([^\/]+)(:)(?=\/\/)/,"$1\\$2")}function ca(e,t,r){const n=Kv(t,r),i=typeof n=="string"?Zv(n):n,o=(0,Gv.getCleanUrl)(e),a=(0,zv.match)(i,{decode:decodeURIComponent})(o),s=a&&a.params||{};return{matches:a!==!1,params:s}}var _v=We;function Ml(...e){return(...t)=>e.reduceRight((r,n)=>r instanceof Promise?Promise.resolve(r).then(n):n(r),t[0])}var Ql={status:200,statusText:"OK",body:null,delay:0,once:!1,passthrough:!1},$v=[];function io(e,t=$v){return async(...r)=>{const n=Object.assign({},Ql,{headers:new _v.Headers({"x-powered-by":"msw"})},e),i=[...t,...r].filter(Boolean);return i.length>0?Ml(...i)(n):n}}var Ul=Object.assign(io(),{once:io({once:!0}),networkError(e){throw new Cl(e)}}),eg=/[\/\\]msw[\/\\]src[\/\\](.+)/,tg=/(node_modules)?[\/\\]lib[\/\\](umd|esm|iief|cjs)[\/\\]|^[^\/\\]*$/;function rg(e){const t=e.stack;if(!t)return;const n=t.split(`
`).slice(1).find(o=>!(eg.test(o)||tg.test(o)));return n?n.replace(/\s*at [^()]*\(([^)]+)\)/,"$1").replace(/^@/,""):void 0}function ng(e){return e?typeof e[Symbol.iterator]=="function":!1}var ei={status:gl,set:ml,delay:Dl,fetch:wl},la=class{constructor(e){this.shouldSkip=!1,this.ctx=e.ctx||ei,this.resolver=e.resolver;const t=rg(new Error);this.info={...e.info,callFrame:t}}parse(e,t){return null}test(e,t){return this.predicate(e,this.parse(e,t),t)}getPublicRequest(e,t){return e}markAsSkipped(e=!0){this.shouldSkip=e}async run(e,t){if(this.shouldSkip)return null;const r=this.parse(e,t);if(!this.predicate(e,r,t))return null;const i=this.getPublicRequest(e,r),a=await this.wrapResolver(this.resolver)(i,Ul,this.ctx);return this.createExecutionResult(r,i,a)}wrapResolver(e){return async(t,r,n)=>{const i=this.resolverGenerator||await e(t,r,n);if(ng(i)){const{value:o,done:a}=i[Symbol.iterator]().next(),s=await o;return!s&&a?this.resolverGeneratorResult:(this.resolverGenerator||(this.resolverGenerator=i),this.resolverGeneratorResult=s,s)}return i}}createExecutionResult(e,t,r){return{handler:this,parsedResult:e||null,request:t,response:r||null}}},jl=(e=>(e.HEAD="HEAD",e.GET="GET",e.POST="POST",e.PUT="PUT",e.PATCH="PATCH",e.OPTIONS="OPTIONS",e.DELETE="DELETE",e))(jl||{}),ql={...ei,cookie:oa,body:yl,text:Il,json:dr,xml:Sl},ig=class extends tn{constructor(e,t){super(e.url,{...e,body:e._body}),this.params=t,this.id=e.id}},fa=class extends la{constructor(e,t,r){super({info:{header:`${e} ${t}`,path:t,method:e},ctx:ql,resolver:r}),this.checkRedundantQueryParameters()}checkRedundantQueryParameters(){const{method:e,path:t}=this.info;if(t instanceof RegExp||ua(t)===t)return;Jv(t).forEach((i,o)=>{}),ve.warn(`Found a redundant usage of query parameters in the request handler URL for "${e} ${t}". Please match against a path instead and access query parameters in the response resolver function using "req.url.searchParams".`)}parse(e,t){return ca(e.url,this.info.path,t?.baseUrl)}getPublicRequest(e,t){return new ig(e,t.params||{})}predicate(e,t){return(this.info.method instanceof RegExp?this.info.method.test(e.method):sa(this.info.method,e.method))&&t.matches}log(e,t){const r=rn(e),n=xl(e),i=Fl(t),o=kl(t.status);console.groupCollapsed(ve.formatMessage("%s %s %s (%c%s%c)"),Ll(),e.method,r,`color:${o}`,`${t.status} ${t.statusText}`,"color:inherit"),console.log("Request",n),console.log("Handler:",this),console.log("Response",i),console.groupEnd()}},gn=gt,og=(e,t)=>r=>{ag(e);const n=wt(r.body)||{},i=pr(n,{[e]:t});return dr(i)(r)};function ag(e){(0,gn.invariant)(e.trim()!=="",ve.formatMessage("Failed to set a custom field on a GraphQL response: field name cannot be empty.")),(0,gn.invariant)(e!=="data",ve.formatMessage('Failed to set a custom "%s" field on a mocked GraphQL response: forbidden field name. Did you mean to call "ctx.data()" instead?',e)),(0,gn.invariant)(e!=="errors",ve.formatMessage('Failed to set a custom "%s" field on a mocked GraphQL response: forbidden field name. Did you mean to call "ctx.errors()" instead?',e)),(0,gn.invariant)(e!=="extensions",ve.formatMessage('Failed to set a custom "%s" field on a mocked GraphQL response: forbidden field name. Did you mean to call "ctx.extensions()" instead?',e))}function Hl(e,t){try{return e()}catch(r){t?.(r)}}var Vl={...ei,data:El,extensions:bl,errors:Tl,cookie:oa,field:og};function sg(e){return e==null?!1:typeof e=="object"&&"kind"in e&&"definitions"in e}var ug=class extends tn{constructor(e,t,r){super(e.url,{...e,body:e._body}),this.variables=t,this.operationName=r}},ti=class extends la{constructor(e,t,r,n){let i=t;if(sg(t)){const a=Pl(t);if(a.operationType!==e)throw new Error(`Failed to create a GraphQL handler: provided a DocumentNode with a mismatched operation type (expected "${e}", but got "${a.operationType}").`);if(!a.operationName)throw new Error("Failed to create a GraphQL handler: provided a DocumentNode with no operation name.");i=a.operationName}const o=e==="all"?`${e} (origin: ${r.toString()})`:`${e} ${i} (origin: ${r.toString()})`;super({info:{header:o,operationType:e,operationName:i},ctx:Vl,resolver:n}),this.endpoint=r}parse(e){return Hl(()=>Rl(e),t=>console.error(t.message))}getPublicRequest(e,t){var r,n;return new ug(e,(r=t?.variables)!=null?r:{},(n=t?.operationName)!=null?n:"")}predicate(e,t){if(!t)return!1;if(!t.operationName&&this.info.operationType!=="all"){const o=rn(e);return ve.warn(`Failed to intercept a GraphQL request at "${e.method} ${o}": anonymous GraphQL operations are not supported.

Consider naming this operation or using "graphql.operation()" request handler to intercept GraphQL requests regardless of their operation name/type. Read more: https://mswjs.io/docs/api/graphql/operation      `),!1}const r=ca(e.url,this.endpoint),n=this.info.operationType==="all"||t.operationType===this.info.operationType,i=this.info.operationName instanceof RegExp?this.info.operationName.test(t.operationName||""):t.operationName===this.info.operationName;return r.matches&&n&&i}log(e,t,r){const n=xl(e),i=Fl(t),o=kl(t.status),a=r?.operationName?`${r?.operationType} ${r?.operationName}`:`anonymous ${r?.operationType}`;console.groupCollapsed(ve.formatMessage("%s %s (%c%s%c)"),Ll(),`${a}`,`color:${o}`,`${t.status} ${t.statusText}`,"color:inherit"),console.log("Request:",n),console.log("Handler:",this),console.log("Response:",i),console.groupEnd()}},cg=3,lg=4,zl=.5;function fg(e){return e.reduce((t,r)=>(r instanceof fa&&t.rest.push(r),r instanceof ti&&t.graphql.push(r),t),{rest:[],graphql:[]})}function pg(){return(e,t)=>{const{path:r,method:n}=t.info;if(r instanceof RegExp||n instanceof RegExp)return 1/0;const o=sa(e.method,n)?zl:0,a=rn(e);return(0,Ol.default)(a,r)-o}}function dg(e){return(t,r)=>{if(typeof e.operationName>"u")return 1/0;const{operationType:n,operationName:i}=r.info;if(typeof i!="string")return 1/0;const a=e.operationType===n?zl:0;return(0,Ol.default)(e.operationName,i)-a}}function hg(e,t,r){return t.reduce((i,o)=>{const a=r(e,o);return i.concat([[a,o]])},[]).sort(([i],[o])=>i-o).filter(([i])=>i<=cg).slice(0,lg).map(([,i])=>i)}function Ag(e){return e.length>1?`Did you mean to request one of the following resources instead?

${e.map(t=>`  • ${t.info.header}`).join(`
`)}`:`Did you mean to request "${e[0].info.header}" instead?`}function vg(e,t,r="warn"){const n=Hl(()=>Rl(e));function i(){const s=fg(t),u=n?s.graphql:s.rest,c=hg(e,u,n?dg(n):pg());return c.length>0?Ag(c):""}function o(){const s=rn(e),u=n?`${n.operationType} ${n.operationName} (${e.method} ${s})`:`${e.method} ${s}`,c=i();return["captured a request without a matching request handler:",`  • ${u}`,c,`If you still wish to intercept this unhandled request, please create a request handler for it.
Read more: https://mswjs.io/docs/getting-started/mocks`].filter(Boolean).join(`

`)}function a(s){const u=o();switch(s){case"error":throw ve.error("Error: %s",u),new Error(ve.formatMessage('Cannot bypass a request when using the "error" strategy for the "onUnhandledRequest" option.'));case"warn":{ve.warn("Warning: %s",u);break}case"bypass":break;default:throw new Error(ve.formatMessage('Failed to react to an unhandled request: unknown strategy "%s". Please provide one of the supported strategies ("bypass", "warn", "error") or a custom callback function as the value of the "onUnhandledRequest" option.',s))}}if(typeof r=="function"){r(e,{warning:a.bind(null,"warn"),error:a.bind(null,"error")});return}a(r)}var Ks=Ao;function gg(e,t){Ks.store.add({...e,url:e.url.toString()},t),Ks.store.persist()}async function pa(e,t,r,n,i){var o,a,s,u,c,l;if(n.emit("request:start",e),e.headers.get("x-msw-bypass")==="true"){n.emit("request:end",e),(o=i?.onPassthroughResponse)==null||o.call(i,e);return}const[f,d]=await(0,Mv.until)(()=>Qv(e,t,i?.resolutionContext));if(f)throw n.emit("unhandledException",f,e),f;const{handler:v,response:w}=d;if(!v){vg(e,t,r.onUnhandledRequest),n.emit("request:unhandled",e),n.emit("request:end",e),(a=i?.onPassthroughResponse)==null||a.call(i,e);return}if(!w){ve.warn(`Expected response resolver to return a mocked response Object, but got %s. The original response is going to be used instead.

  • %s
    %s`,w,v.info.header,v.info.callFrame),n.emit("request:end",e),(s=i?.onPassthroughResponse)==null||s.call(i,e);return}if(w.passthrough){n.emit("request:end",e),(u=i?.onPassthroughResponse)==null||u.call(i,e);return}gg(e,w),n.emit("request:match",e);const T=d,A=((c=i?.transformResponse)==null?void 0:c.call(i,w))||w;return(l=i?.onMockedResponse)==null||l.call(i,A,T),n.emit("request:end",e),A}var Zs=We;async function Gl(e){return{status:e.status,statusText:e.statusText,headers:(0,Zs.flattenHeadersObject)((0,Zs.headersToObject)(e.headers)),body:await e.clone().text()}}var mg=(e,t)=>async(r,n)=>{var i;const o=new wv(r.ports[0]),a=Fv(n.payload);try{await pa(a,e.requestHandlers,t,e.emitter,{transformResponse:yg,onPassthroughResponse(){o.postMessage("NOT_FOUND")},async onMockedResponse(s,{handler:u,publicRequest:c,parsedRequest:l}){if(s.body instanceof ReadableStream)throw new Error(ve.formatMessage('Failed to construct a mocked response with a "ReadableStream" body: mocked streams are not supported. Follow https://github.com/mswjs/msw/issues/1336 for more details.'));const f=new Response(s.body,s),d=f.clone(),v=await f.arrayBuffer(),w=s.body==null?null:v;o.postMessage("MOCK_RESPONSE",{...s,body:w},[v]),t.quiet||e.emitter.once("response:mocked",async()=>{u.log(c,await Gl(d),l)})}})}catch(s){if(s instanceof Cl){o.postMessage("NETWORK_ERROR",{name:s.name,message:s.message});return}s instanceof Error&&(ve.error(`Uncaught exception in the request handler for "%s %s":

%s

This exception has been gracefully handled as a 500 response, however, it's strongly recommended to resolve this error, as it indicates a mistake in your code. If you wish to mock an error response, please see this guide: https://mswjs.io/docs/recipes/mocking-error-responses`,a.method,a.url,(i=s.stack)!=null?i:s),o.postMessage("MOCK_RESPONSE",{status:500,statusText:"Request Handler Error",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:s.name,message:s.message,stack:s.stack})}))}};function yg(e){return{status:e.status,statusText:e.statusText,headers:e.headers.all(),body:e.body,delay:e.delay}}async function Eg(e,t){e.workerChannel.send("INTEGRITY_CHECK_REQUEST");const{payload:r}=await e.events.once("INTEGRITY_CHECK_RESPONSE");if(r!=="3d6b9f06410d179a7f7404d4bf4c3c70")throw new Error(`Currently active Service Worker (${r}) is behind the latest published one (3d6b9f06410d179a7f7404d4bf4c3c70).`);return t}var _s=St;function bg(e){const t=window.XMLHttpRequest.prototype.send;window.XMLHttpRequest.prototype.send=function(...n){(0,_s.until)(()=>e).then(()=>{window.XMLHttpRequest.prototype.send=t,this.send(...n)})};const r=window.fetch;window.fetch=async(...n)=>(await(0,_s.until)(()=>e),window.fetch=r,window.fetch(...n))}function Dg(e){return(t,r)=>{var n;const{payload:i}=r;if((n=i.type)!=null&&n.includes("opaque"))return;const o=new Response(i.body||null,i);o.headers.get("x-powered-by")==="msw"?e.emitter.emit("response:mocked",o,i.requestId):e.emitter.emit("response:bypass",o,i.requestId)}}function Tg(e,t){!t?.quiet&&!location.href.startsWith(e.scope)&&ve.warn(`Cannot intercept requests on this page because it's outside of the worker's scope ("${e.scope}"). If you wish to mock API requests on this page, you must resolve this scope issue.

- (Recommended) Register the worker at the root level ("/") of your application.
- Set the "Service-Worker-Allowed" response header to allow out-of-scope workers.`)}var wg=e=>function(r,n){const o=(async()=>{e.events.removeAllListeners(),e.workerChannel.on("REQUEST",mg(e,r)),e.workerChannel.on("RESPONSE",Dg(e));const a=await Dv(r.serviceWorker.url,r.serviceWorker.options,r.findWorker),[s,u]=a;if(!s){const l=n?.findWorker?ve.formatMessage(`Failed to locate the Service Worker registration using a custom "findWorker" predicate.
...
If this message still persists after updating, please report an issue: https://github.com/open-draft/msw/issues      `),e.keepAliveInterval=window.setInterval(()=>e.workerChannel.send("KEEPALIVE_REQUEST"),5e3),Tg(u,e.startOptions),u})().then(async a=>{const s=a.installing||a.waiting;return s&&await new Promise(u=>{s.addEventListener("statechange",()=>{if(s.state==="activated")return u()})}),await Tv(e,r).catch(u=>{throw new Error(`Failed to enable mocking: ${u?.message}`)}),a});return r.waitUntilReady&&bg(o),o};function Xl(e={}){e.quiet||console.log(`%c${ve.formatMessage("Mocking disabled.")}`,"color:orangered;font-weight:bold;")}var Ig=e=>function(){var r;if(!e.isMockingEnabled){ve.warn('Found a redundant "worker.stop()" call. Note that stopping the worker while mocking already stopped has no effect. Consider removing this "worker.stop()" call.');return}e.workerChannel.send("MOCK_DEACTIVATE"),e.isMockingEnabled=!1,window.clearInterval(e.keepAliveInterval),Xl({quiet:(r=e.startOptions)==null?void 0:r.quiet})},Sg={serviceWorker:{url:"/mockServiceWorker.js",options:null},quiet:!1,waitUntilReady:!0,onUnhandledRequest:"warn",findWorker(e,t){return e===t}},Ng=kn,Cg=MA(),Bg=JA();function Og(e){return new Response(e.body,{status:e.status,statusText:e.statusText,headers:e.headers})}function Pg(e,t){const r=new Ng.BatchInterceptor({name:"fallback",interceptors:[new Cg.FetchInterceptor,new Bg.XMLHttpRequestInterceptor]});return r.on("request",async n=>{const i=new tn(n.url,{...n,body:await n.arrayBuffer()}),o=await pa(i,e.requestHandlers,t,e.emitter,{transformResponse(a){return{status:a.status,statusText:a.statusText,headers:a.headers.all(),body:a.body,delay:a.delay}},onMockedResponse(a,{handler:s,publicRequest:u,parsedRequest:c}){t.quiet||e.emitter.once("response:mocked",async l=>{s.log(u,await Gl(l),c)})}});o&&n.respondWith(o)}),r.on("response",(n,i)=>{if(!n.id)return;const o=Og(i);i.headers.get("x-powered-by")==="msw"?e.emitter.emit("response:mocked",o,n.id):e.emitter.emit("response:bypass",o,n.id)}),r.apply(),r}function Rg(e){return async function(r){e.fallbackInterceptor=Pg(e,r),Nl({message:"Mocking enabled (fallback mode).",quiet:r.quiet})}}function kg(e){return function(){var r,n;(r=e.fallbackInterceptor)==null||r.dispose(),Xl({quiet:(n=e.startOptions)==null?void 0:n.quiet})}}var Lg=gt,$s=YA();function xg(e,t){const r=e.emit;r._isPiped||(e.emit=function(n,...i){return t.emit(n,...i),r.call(this,n,...i)},e.emit._isPiped=!0)}function eu(e){const t=[...e];return Object.freeze(t),t}var Jl=class{constructor(...e){this.validateHandlers(...e),this.initialHandlers=eu(e),this.currentHandlers=[...e],this.emitter=new $s.Emitter,this.publicEmitter=new $s.Emitter,xg(this.emitter,this.publicEmitter),this.events=this.createLifeCycleEvents()}validateHandlers(...e){for(const t of e)(0,Lg.invariant)(!Array.isArray(t),ve.formatMessage('Failed to construct "%s" given an Array of request handlers. Make sure you spread the request handlers when calling the respective setup function.'),this.constructor.name)}dispose(){this.emitter.removeAllListeners(),this.publicEmitter.removeAllListeners()}use(...e){this.currentHandlers.unshift(...e)}restoreHandlers(){this.currentHandlers.forEach(e=>{e.markAsSkipped(!1)})}resetHandlers(...e){this.currentHandlers=e.length>0?[...e]:[...this.initialHandlers]}listHandlers(){return eu(this.currentHandlers)}createLifeCycleEvents(){return{on:(...e)=>this.publicEmitter.on(...e),removeListener:(...e)=>this.publicEmitter.removeListener(...e),removeAllListeners:(...e)=>this.publicEmitter.removeAllListeners(...e)}}},Wl=class extends Jl{constructor(...e){super(...e),this.startHandler=null,this.stopHandler=null,(0,gv.invariant)(!(0,mv.isNodeProcess)(),ve.formatMessage("Failed to execute `setupWorker` in a non-browser environment. Consider using `setupServer` for Node.js environment instead.")),this.listeners=[],this.context=this.createWorkerContext()}createWorkerContext(){const e={isMockingEnabled:!1,startOptions:null,worker:null,registration:null,requestHandlers:this.currentHandlers,emitter:this.emitter,workerChannel:{on:(t,r)=>{this.context.events.addListener(navigator.serviceWorker,"message",n=>{if(n.source!==this.context.worker)return;const i=n.data;i&&i.type===t&&r(n,i)})},send:t=>{var r;(r=this.context.worker)==null||r.postMessage(t)}},events:{addListener:(t,r,n)=>(t.addEventListener(r,n),this.listeners.push({eventType:r,target:t,callback:n}),()=>{t.removeEventListener(r,n)}),removeAllListeners:()=>{for(const{target:t,eventType:r,callback:n}of this.listeners)t.removeEventListener(r,n);this.listeners=[]},once:t=>{const r=[];return new Promise((n,i)=>{const o=a=>{try{const s=a.data;s.type===t&&n(s)}catch(s){i(s)}};r.push(this.context.events.addListener(navigator.serviceWorker,"message",o),this.context.events.addListener(navigator.serviceWorker,"messageerror",i))}).finally(()=>{r.forEach(n=>n())})}},useFallbackMode:!("serviceWorker"in navigator)||location.protocol==="file:"};return Object.defineProperties(e,{requestHandlers:{get:()=>this.currentHandlers}}),this.startHandler=e.useFallbackMode?Rg(e):wg(e),this.stopHandler=e.useFallbackMode?kg(e):Ig(e),e}async start(e={}){return this.context.startOptions=pr(Sg,e),await this.startHandler(this.context.startOptions,e)}printHandlers(){this.listHandlers().forEach(t=>{const{header:r,callFrame:n}=t.info,i=t.info.hasOwnProperty("operationType")?"[graphql]":"[rest]";console.groupCollapsed(`${i} ${r}`),n&&console.log(`Declaration: ${n}`),console.log("Handler:",t),console.groupEnd()})}stop(){super.dispose(),this.context.events.removeAllListeners(),this.context.emitter.removeAllListeners(),this.stopHandler()}};function Fg(...e){return new Wl(...e)}function yt(e){return(t,r)=>new fa(e,t,r)}var Mg={all:yt(/.+/),head:yt("HEAD"),get:yt("GET"),post:yt("POST"),put:yt("PUT"),delete:yt("DELETE"),patch:yt("PATCH"),options:yt("OPTIONS")};function Pn(e,t){return(r,n)=>new ti(e,r,t,n)}function Yl(e){return t=>new ti("all",new RegExp(".*"),e,t)}var Qg={operation:Yl("*"),query:Pn("query","*"),mutation:Pn("mutation","*")};function Ug(e){return{operation:Yl(e),query:Pn("query",e),mutation:Pn("mutation",e)}}var jg={...Qg,link:Ug};vv();const qg=`iVBORw0KGgoAAAANSUhEUgAAAqgAAAKoCAYAAAC7uA1cAAAABHNCSVQICAgIfAhkiAAAIABJREFU
